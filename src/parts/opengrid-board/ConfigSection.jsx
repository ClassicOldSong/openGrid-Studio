...
import BoundSelect from "../../components/BoundSelect.jsx";
import {
	CHIP_BUTTON_CLASS,
	COMPACT_INPUT_CLASS,
	FIELD_LABEL_CLASS,
...
export default function OpenGridBoardConfigSection({ section }) {
			...
			<div class={SECTION_CLASS}>
				...
				<div class="flex flex-wrap gap-2">
					{[
						...
						<button class={CHIP_BUTTON_CLASS} on:click={() => applyHelper(mode)}>
							{label}
						</button>
					))}
				</div>
			...
			<div class={SECTION_CLASS}>
				...
				<label class={TOGGLE_LABEL_CLASS}>
					<input
						...
						on:change={(e) => (screwHeadIsCountersunk.value = e.target.checked)}
					/>
					Countersunk
				</label>
			</div>
					...
					<div class={SECTION_CLASS}>
						...
						<label class={TOGGLE_LABEL_CLASS}>
							<input
								...
								on:change={(e) => (backsideScrewHole.value = e.target.checked)}
							/>
							Enable backside
						</label>
						<div class="grid grid-cols-2 gap-x-4 gap-y-3">
						...
						<label class={TOGGLE_LABEL_CLASS}>
							<input
								...
								on:change={(e) =>
									(backsideScrewHeadIsCountersunk.value = e.target.checked)
								}
							/>
					...
					<div class={SECTION_CLASS}>
						...
						<label class={TOGGLE_LABEL_CLASS}>
							<input
								...
								on:change={(e) => (addAdhesiveBase.value = e.target.checked)}
							/>
							Enable base
						</label>
						<div class="grid gap-1">
							...
							<input
								...
								on:input={(e) =>
									(adhesiveBaseThicknessValue.value = clampNumberInput(
										e.target.value,
										MEASUREMENT_MIN,
										Infinity,
